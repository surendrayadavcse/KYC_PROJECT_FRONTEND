...
const Dashboard = () => {
  ...
  <div className="alert alert-success d-flex align-items-center p-4 mb-4 rounded shadow">
    <div className="me-3">
      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="green" className="bi bi-check-circle-fill" viewBox="0 0 16 16">
    ...
    <div>
      ...
      <p className="mb-0 text-success">You’ve successfully completed your KYC. All services are now unlocked for you.</p>
    </div>
  </div>
)}
...
{Kycstatus !== "KYC COMPLETED" && (
  <div className="d-flex justify-content-between align-items-center p-4 mb-4 rounded shadow-sm bg-white border">
    <div>
      ...
      <p className="mb-0 text-dark">Complete your KYC Verification to unlock access to all services.</p>
      <button className="btn btn-primary mt-3">Start KYC Verification</button>
    </div>
